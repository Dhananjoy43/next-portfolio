...
export function Contact() {
    ...
    return (
        <Section className="w-full flex flex-col mt-16">
            ...
            <div className="w-full flex flex-col xl:flex-row justify-center items-center gap-6 my-6">
                <Image
                ...
                <Form {...form}>
                    ...
                    >
                        ...
                        />
                        <Button
                            className="bg-gradient-to-br from-purple-500 to-purple-600  text-white rounded-[2rem] text-base font-medium"
                            type="submit"
                            disabled={isPending}
                        >
